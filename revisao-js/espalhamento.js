console.log(Math.min(14,7,-3,34))// Retorna o menor valor passado
console.log(Math.max(14,7,-3,34))// Retorna o maior valor passado

let numeros = [14,7,-3,34]

//Usando espalhamento para "desmontar o vetor"
console.log(Math.min(...numeros))
console.log(Math.max(...numeros))

let maisNumeros =[4,0,11,...numeros,8,19,26,23]
console.log(maisNumeros)

//Função com parâmeto (ou argumento) de resto
...
//Argumento convecional + argumento de resto
